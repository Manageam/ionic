...
const routes = [
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_modules_logged_logged_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./modules/logged/logged.module */ 5443)).then((m) => m.LoggedModule),
    },
    {
        path: 'auth',
