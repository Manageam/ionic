...
let CategoryComponent = class CategoryComponent {
    constructor(modalController, educationService, platform) {
    ...
    view(topic) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(this, void 0, void 0, function* () {
            const modal = yield this.modalController.create({
                component: _single_single_component__WEBPACK_IMPORTED_MODULE_3__.SingleComponent,
                componentProps: {
                    topic,
                },
            });
...
CategoryComponent.ctorParameters = () => [
    ...
    { type: src_app_services_education_education_service__WEBPACK_IMPORTED_MODULE_2__.EducationService },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_5__.Platform }
];
CategoryComponent.propDecorators = {
    data: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_6__.Input }]
};
CategoryComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
        selector: 'app-category',
        template: _raw_loader_category_component_html__WEBPACK_IMPORTED_MODULE_0__.default,
        styles: [_category_component_scss__WEBPACK_IMPORTED_MODULE_1__.default]
    })
], CategoryComponent);
...
EducationPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_6__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_8__.IonicModule, _education_routing_module__WEBPACK_IMPORTED_MODULE_0__.EducationPageRoutingModule],
        declarations: [_education_page__WEBPACK_IMPORTED_MODULE_1__.EducationPage, _category_category_component__WEBPACK_IMPORTED_MODULE_2__.CategoryComponent, _single_single_component__WEBPACK_IMPORTED_MODULE_3__.SingleComponent],
    })
], EducationPageModule);
...
/***/ 5318:
/*!**********************************************************!*\
  !*** ./src/app/pages/logged/education/education.page.ts ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var src_app_services_websocket_websocket_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/websocket/websocket.service */ 86557);
/* harmony import */ var src_app_services_authentication_authentication_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/services/authentication/authentication.service */ 97020);
...
let EducationPage = class EducationPage {
    constructor(modalController, educationService, webSocketService, auth) {
        this.modalController = modalController;
        this.educationService = educationService;
        this.webSocketService = webSocketService;
        this.auth = auth;
        this.categories = [];
        this.randomEducational = {};
    }
    ngOnInit() {
        ...
        this.educationService.categories.subscribe((categories) => {
            const colors = (0,lodash__WEBPACK_IMPORTED_MODULE_5__.shuffle)([
                'bg-red-300',
                'bg-green-300',
                'bg-indigo-300',
                'bg-purple-300',
            ...
            this.categories = categories.map((c, i) => (Object.assign(Object.assign({}, c), { bg: colors[i] })));
        });
        this.educationService.randomEducational.subscribe((data) => (this.randomEducational = data));
    ...
    viewEducation() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__awaiter)(this, void 0, void 0, function* () {
            const modal = yield this.modalController.create({
                component: _single_single_component__WEBPACK_IMPORTED_MODULE_4__.SingleComponent,
                componentProps: {
...
EducationPage.ctorParameters = () => [
    ...
    { type: src_app_services_education_education_service__WEBPACK_IMPORTED_MODULE_2__.EducationService },
    { type: src_app_services_websocket_websocket_service__WEBPACK_IMPORTED_MODULE_6__.WebsocketService },
    { type: src_app_services_authentication_authentication_service__WEBPACK_IMPORTED_MODULE_7__.AuthenticationService }
];
EducationPage = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("<ion-app>\n  <ion-header\n    class=\"p-4 flex items-center ion-no-border font-geomanist font-bold text-xl\"\n  >\n    <ion-icon\n      name=\"arrow-back\"\n      class=\"text-2xl\"\n      (click)=\"modalController.dismiss()\"\n    ></ion-icon>\n    <span class=\"inline-block ml-4 mt-2\" (click)=\"modalController.dismiss()\"\n      >Education</span\n    >\n  </ion-header>\n  <ion-content>\n    <div class=\"font-geomanist text-gray-900 p-4 text-center\">\n      <h2 class=\"text-3xl mb-4 font-semibold\">{{ category.category }}</h2>\n      <p class=\"text-gray-800 text-xl font-geomanist pb-4\">\n        {{ category.subtitle }}\n      </p>\n    </div>\n    <div class=\"bg-paleBg font-bold p-4\">All topics</div>\n    <ul class=\"p-4 font-geomanist space-y-4\">\n      <li\n        class=\"flex items-center justify-between my-6 text-xl\"\n        *ngFor=\"let topic of topics\"\n        (click)=\"view(topic)\"\n      >\n        <p class=\"truncate font-semibold text-gray-800\">\n          {{\n            topic.topic.length > 40\n              ? (topic.topic | slice: 0:40) + \"...\"\n              : topic.topic\n          }}\n          <!-- {{ topic.topic }} -->\n        </p>\n        <ion-icon\n          name=\"chevron-forward\"\n          class=\"inline-block ml-3 text-2xl text-gray-900\"\n        ></ion-icon>\n      </li>\n    </ul>\n  </ion-content>\n</ion-app>\n");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("<div class=\"text-gray-900 pale-bg-default min-h-full\">\n  <p class=\"p-4 text-lg\">Suggested for you</p>\n  <div\n    class=\"flex justify-between bg-white px-4 py-6 items-center\"\n    (click)=\"viewEducation()\"\n  >\n    <p class=\"font-bold text-xl\">{{randomEducational?.topic}}</p>\n    <ion-icon name=\"chevron-forward\" class=\"text-2xl\"></ion-icon>\n  </div>\n\n  <p class=\"mt-4 p-4 text-lg font-semibold\">Categories</p>\n  <ul class=\"px-4 text-gray-900 pb-4\">\n    <li\n      class=\"p-4 flex {{category.bg}} justify-between\"\n      *ngFor=\"let category of categories\"\n      (click)=\"viewCategory(category)\"\n    >\n      <div class=\"\">\n        <h3 class=\"text-xl font-bold mb-2\">{{category.category}}</h3>\n        <p>{{category.subtitle}}</p>\n      </div>\n      <div class=\"flex items-center\">\n        <span class=\"text-lg inline-block mr-1\">{{category.count}}</span>\n        <ion-icon name=\"chevron-forward\" class=\"text-xl\"></ion-icon>\n      </div>\n    </li>\n  </ul>\n</div>\n");

/***/ })

}]);
//# sourceMappingURL=src_app_pages_logged_education_education_module_ts.js.map